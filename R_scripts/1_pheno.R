...
a1 <- read.csv("~/Documents/git/Norberg_2020/BLUE_values/FA/1_MSC/1_stage/predictions_2stage_ASReml_mrbean.csv")
...
a2 <- read.csv("~/Documents/git/Norberg_2020/BLUE_values/FA/2_DM/1_stage/predictions_2stage_ASReml_mrbean.csv")
...
a3 <- read.csv("~/Documents/git/Norberg_2020/BLUE_values/FA/3_Height/1_stage/predictions_2stage_ASReml_mrbean.csv")
...
a4 <- read.csv("~/Documents/git/Norberg_2020/BLUE_values/FA/4_Yield/1_stage/predictions_2stage_ASReml_mrbean.csv")
...
a5 <- read.csv("~/Documents/git/Norberg_2020/BLUE_values/FA/5_FD/1_stage/predictions_2stage_ASReml_mrbean.csv")
...
setwd("~/Documents/git/Norberg_2020/BLUE_values/FA/1_MSC/2_stage/")
...
setwd("~/Documents/git/Norberg_2020/BLUE_values/FA/3_Height/2_stage/")
data_2st <- list.files(pattern = "2stage.csv", full.names = T)
...
setwd("~/Documents/git/Norberg_2020/BLUE_values/FA/4_Yield/2_stage/")
data_2st <- list.files(pattern = "2stage.csv", full.names = T)
...
setwd("~/Documents/git/Norberg_2020/BLUE_values/FA/1_MSC/3_stage/")
...
setwd("~/Documents/git/Norberg_2020/BLUE_values/FA/2_DM/3_stage/")
data_3st <- list.files(pattern = "2stage.csv", full.names = T)
# list_4 <- gsub(".csv", "", gsub("./", "ST3_", data_3st))
...
setwd("~/Documents/git/Norberg_2020/BLUE_values/FA/3_Height/3_stage/")
data_3st <- list.files(pattern = "2stage.csv", full.names = T)
# list_4 <- gsub(".csv", "", gsub("./", "ST3_", data_3st))
...
setwd("~/Documents/git/Norberg_2020/BLUE_values/FA/4_Yield/3_stage/")
data_3st <- list.files(pattern = "2stage.csv", full.names = T)
# list_4 <- gsub(".csv", "", gsub("./", "ST3_", data_3st))
...
e1 <- read.csv("~/Documents/git/Norberg_2020/BLUE_values/FA/1_MSC/4_stage/Overall_predictions_2stage.csv")
e1 <- e1 %>% dplyr::select(1,2) %>% remove_rownames() %>% column_to_rownames(var = "gen") %>% rownames_to_column(var = "gen")
colnames(e1)[2] <- "ST4_MS_Overall"

e2 <- read.csv("~/Documents/git/Norberg_2020/BLUE_values/FA/2_DM/4_stage/Overall_predictions_2stage.csv")
e2 <- e2 %>% dplyr::select(1,2) %>% remove_rownames() %>% column_to_rownames(var = "gen") %>% rownames_to_column(var = "gen") 
colnames(e2)[2] <- "ST4_DM_Overall"

e3 <- read.csv("~/Documents/git/Norberg_2020/BLUE_values/FA/3_Height/4_stage/Overall_predictions_2stage.csv")
e3 <- e3 %>% dplyr::select(1,2) %>% remove_rownames() %>% column_to_rownames(var = "gen") %>% rownames_to_column(var = "gen")
colnames(e3)[2] <- "ST4_He_Overall"

e4 <- read.csv("~/Documents/git/Norberg_2020/BLUE_values/FA/4_Yield/4_stage/Overall_predictions_2stage.csv")
e4 <- e4 %>% dplyr::select(1,2) %>% remove_rownames() %>% column_to_rownames(var = "gen") %>% rownames_to_column(var = "gen") 
colnames(e4)[2] <- "ST4_Yi_Overall"

e5 <- read.csv("~/Documents/git/Norberg_2020/BLUE_values/FA/5_FD/4_stage/Overall_predictions_2stage.csv")
...
write.csv(f1, "~/Documents/git/big_files/pheno_fa.csv", quote = F, row.names = F)
